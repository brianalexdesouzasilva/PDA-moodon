...
$sql = "SELECT partner, tipo FROM telefoniaefibra";
...
<head>
    ...
    <title>Telefono e Fibra - Step 1</title>
...
<body>
    <div class="container">
        ...
        <h2>Telefono e Fibra - Step 1</h2>
        <form action="telefoniaefibra_step2.php" method="POST">
